            ...
            <b-row>
              ...
              <b-col cols="12" md="6">
                <b-row>
                  ...
                  <b-col cols="6">
                    <div class="my-1 text-right text-truncate">EKfT5eCujEDuMok5kYo8VkG95jRmAnmaaL</div>
                  </b-col>
                </b-row>
              </b-col>
              <b-col cols="12" md="6">
              ...
              <b-col cols="12" md="6">
                <b-row>
                  ...
                  <b-col cols="6">
                    ...
                    >27c9aa37d541201360081755ec4114b99357dfc1486e0e82528b63d13cb2d5d5</div>
                  </b-col>
                </b-row>
              </b-col>
              <b-col cols="12" md="6">
