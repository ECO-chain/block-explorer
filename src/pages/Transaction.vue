        ...
        <b-col cols="12">
          ...
          <div class="block-global p-3 mb-3 rounded-lg">
            <b-row>
              ...
              <b-col cols="6">
                <div class="my-1 text-right text-truncate">148 (bytes)</div>
              </b-col>
              <b-col cols="6">
                <div class="my-1">Received Time</div>
              </b-col>
              <b-col cols="6">
                <div class="my-1 text-right text-truncate">April 7, 2020 2:49:36 AM</div>
              </b-col>
              <b-col cols="6">
              ...
              <b-col cols="6">
                <div class="my-1 text-right text-truncate">03bfb40600</div>
              </b-col>
            </b-row>
          </div>
        </b-col>
